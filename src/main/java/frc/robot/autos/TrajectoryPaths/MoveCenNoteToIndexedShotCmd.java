...
public class MoveCenNoteToIndexedShotCmd extends SequentialCommandGroup {

  /* Constructor */
  public MoveCenNoteToIndexedShotCmd(SwerveSubsystem swerveDrive) {
    ...
    Trajectory moveCenNoteToIndexedShot =
      TrajectoryGenerator.generateTrajectory(
          // Start at the end Pose2d of the MoveSpkrCenToCenNote trajectory
    ...
    SwerveControllerCommand moveCenNoteToIndexedShotCmd =
                                  new SwerveControllerCommand(moveCenNoteToIndexedShot,
                                                              swerveDrive::getPose,
