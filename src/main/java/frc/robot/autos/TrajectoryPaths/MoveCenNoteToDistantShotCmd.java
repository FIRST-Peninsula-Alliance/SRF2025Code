...
public class MoveCenNoteToDistantShotCmd extends SequentialCommandGroup {
  ...
  public MoveCenNoteToDistantShotCmd(SwerveSubsystem swerveDrive) {
    ...
    Trajectory moveCenNoteToDistantShot =
      TrajectoryGenerator.generateTrajectory(
          ...
          List.of(new Translation2d(Units.inchesToMeters(119.0), 
                                    Units.inchesToMeters(57.0)),
                  new Translation2d(Units.inchesToMeters(116.0), 
                                    Units.inchesToMeters(57.0)),
    ...
    SwerveControllerCommand moveCenNoteToDistantShotCmd =
                                  new SwerveControllerCommand(moveCenNoteToDistantShot,
                                                              swerveDrive::getPose,
