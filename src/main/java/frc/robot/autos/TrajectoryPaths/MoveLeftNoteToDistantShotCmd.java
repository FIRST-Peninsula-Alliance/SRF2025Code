...
public class MoveLeftNoteToDistantShotCmd extends SequentialCommandGroup {

  /* Constructor */
  public MoveLeftNoteToDistantShotCmd(SwerveSubsystem swerveDrive) {
    ...
    Trajectory moveLeftNoteToDistantShot =
      TrajectoryGenerator.generateTrajectory(
          // Start at the end Pose2d of the MoveDistantShotToLeftNote trajectory
    ...
    SwerveControllerCommand moveLeftNoteToDistantShotCmd =
                                  new SwerveControllerCommand(moveLeftNoteToDistantShot,
                                                              swerveDrive::getPose,
